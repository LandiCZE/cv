...
const cvData = {
  cs: {
    ...
    profile:
      "Junior backend developer se silnými základy programování a práce s daty. Mám zkušenosti s backendem v TypeScriptu, návrhem API a týmovou spoluprací. Hledám příležitost růst jako developer a učit se od zkušenějších kolegů.",
    linkedinHighlights: [
  ...
  en: {
    ...
    profile:
      "Junior backend developer with solid programming and data foundations. I have hands-on experience with TypeScript backend development, API design, and team collaboration. I am looking for an opportunity to grow as a developer and learn from more experienced colleagues.",
    linkedinHighlights: [
